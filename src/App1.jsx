    ...
    <nav className={`fixed top-0 w-full z-50 transition-all duration-300 px-[5vw]
      ...
      <div className="max-w-[1100px] mx-auto flex items-center justify-between h-16">
        ...
        <button onClick={() => window.scrollTo({ top:0, behavior:"smooth" })}
          className="font-orbitron text-sm font-bold text-[#00d4ff] tracking-[2px] bg-transparent border-none cursor-pointer whitespace-nowrap">
          &lt;MOHD UMAR /&gt;
        </button>
        {/* Desktop nav */}
...
function Hero() {
  ...
  return (
    <section id="hero" className="min-h-screen flex items-center justify-center px-[5vw] relative z-10">
      ...
      <div className="max-w-[780px] text-center">
        ...
        <p className="font-dmsans text-[#6b8599] text-[clamp(15px,2vw,17px)] mt-6 leading-relaxed max-w-[560px] mx-auto anim-fadeUp-d4">
          A passionate CS graduate building real-world solutions — from AI-powered study tools to performance prediction engines.
        </p>
        {/* CTA Buttons */}
        <div className="flex gap-4 justify-center flex-wrap mt-10 anim-fadeUp-d5">
          <button onClick={() => document.getElementById("projects")?.scrollIntoView({ behavior:"smooth" })}
            className="font-spacemono text-xs font-bold tracking-widest px-8 py-3 rounded bg-[#00d4ff] text-black cursor-pointer border-none shadow-[0_0_20px_rgba(0,212,255,0.3)] hover:-translate-y-1 hover:shadow-[0_0_32px_#00d4ff] transition-all duration-200">
            View Projects
          </button>
          <a href="https://github.com/umar24nov" target="_blank" rel="noreferrer"
            className="font-spacemono text-xs font-bold tracking-widest px-8 py-3 rounded bg-transparent text-[#00d4ff] border border-[#00d4ff] no-underline hover:bg-[rgba(0,212,255,0.1)] hover:-translate-y-1 transition-all duration-200 inline-block">
            GitHub ↗
          </a>
          {/*
            ── Download CV ──
          ...
          */}
          <a href="/resume.pdf" download="Mohd_Umar_Resume.pdf"
            className="font-spacemono text-xs font-bold tracking-widest px-8 py-3 rounded bg-transparent text-[#34d399] border border-[#34d399] no-underline hover:bg-[rgba(52,211,153,0.1)] hover:-translate-y-1 hover:shadow-[0_0_20px_rgba(52,211,153,0.3)] transition-all duration-200 inline-flex items-center gap-2">
            ⬇ Download CV
          </a>
        </div>
        {/* Scroll indicator */}
        <div className="mt-16 anim-fadeUp-d6">
...
function Section({ id, children }) {
  ...
  return <section id={id} ref={ref} className="reveal py-24 px-[5vw] max-w-[1100px] mx-auto relative z-10">{children}</section>;
}
...
function About() {
  const hi = [
    ...
    { icon:"🌐", label:"Skill",    value:"Developer"     },
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-16 items-center">
        <div>
          <p className="font-dmsans text-[#e2eaf2] text-lg leading-loose mb-5">
            Hi! I'm <span className="text-[#00d4ff] font-bold">Mohd Umar</span>, a CS graduate who loves building software that solves real problems. I thrive at the intersection of clean frontend design and solid backend logic.
          </p>
        ...
        <div className="grid grid-cols-2 gap-5">
          {hi.map(h => (
            <div key={h.label} className="bg-[#0d1a2a] border border-[#1a3040] rounded-xl p-6 hover:border-[#00d4ff] transition-colors duration-300">
...
const projects = [
  {
    name:"StudyVault", emoji:"📚", tagline:"Study Companion",
  ...
  },
  {
    ...
    tech:["Python","Scikit-learn","Pandas","NumPy","Fast API" ],
...
function ProjectCard({ project, index }) {
  ...
  return (
    <div ref={ref}
      className={`reveal bg-[#0d1a2a] border border-[#1a3040] ${project.border} rounded-xl p-7 relative overflow-hidden hover:-translate-y-2 hover:shadow-[0_20px_40px_rgba(0,0,0,0.5)] transition-all duration-300`}
  ...
  return (
    <Section id="skills">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-6">
        ...
        <div className="bg-[#0d1a2a] border border-[#1a3040] rounded-xl p-7 hover:border-[#00d4ff] transition-colors duration-300">
        ...
        {/* Tools & Platforms */}
        <div className="bg-[#0d1a2a] border border-[#1a3040] rounded-xl p-7 hover:border-[#34d399] transition-colors duration-300">
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
        ...
        {/* Frontend */}
        <div className="bg-[#0d1a2a] border border-[#1a3040] rounded-xl p-7 hover:border-[#a78bfa] transition-colors duration-300">
        ...
        {/* Backend */}
        <div className="bg-[#0d1a2a] border border-[#1a3040] rounded-xl p-7 hover:border-[#fb923c] transition-colors duration-300">
        ...
        <div className="bg-[#0d1a2a] border border-[#1a3040] rounded-xl p-7 hover:border-[#f472b6] transition-colors duration-300">
...
function CodeSignature() {
  ...
  return (
    <section ref={ref} className="reveal py-24 px-[5vw] max-w-[1100px] mx-auto relative z-10">
      ...
      <div className="relative rounded-2xl overflow-hidden border border-[#1a3040] hover:border-[#00d4ff] transition-colors duration-500 shadow-[0_0_40px_rgba(0,212,255,0.04)]">
        ...
        {/* Code body */}
        <div className="bg-[#070f1a] p-6 md:p-10 overflow-x-auto">
          <pre className="font-spacemono text-sm leading-7 m-0">
            {lines.map((line, i) => (
      ...
      <div className="relative pl-10">
        ...
        {timeline.map((item,i) => (
          <div key={i} className="relative mb-11">
            <div className="absolute -left-[31px] top-4 w-3.5 h-3.5 rounded-full bg-[#00d4ff] border-[3px] border-[#050b14] shadow-[0_0_10px_#00d4ff]" />
            <div className="bg-[#0d1a2a] border border-[#1a3040] rounded-xl p-6 hover:border-[#00d4ff] transition-colors duration-300">
        ...
        <div className="flex flex-col gap-4">
          {contacts.map(c => (
            <a key={c.label} href={c.href} target="_blank" rel="noreferrer"
              className="flex items-center gap-4 bg-[#0d1a2a] border border-[#1a3040] rounded-xl px-6 py-5 no-underline group hover:border-[#00d4ff] hover:translate-x-2 transition-all duration-200">
...
function GitHubMap() {
  ...
  return (
    <section ref={ref} className="reveal py-24 px-[5vw] max-w-[1100px] mx-auto relative z-10">
      ...
      <div className="relative rounded-2xl overflow-hidden border border-[#1a3040] hover:border-[#00d4ff] transition-colors duration-500">
        ...
        <div className="bg-[#070f1a] p-8 md:p-12">
          <div className="flex items-center gap-3 mb-8">
            <div className="w-3 h-3 rounded-full bg-[#00d4ff] shadow-[0_0_8px_#00d4ff] anim-blink" />
            <span className="font-spacemono text-[#00d4ff] text-xs tracking-[3px]">LIVE — github.com/{u}</span>
          </div>
          <div className="flex flex-col gap-6">
            <div className="flex justify-center">
              <img src={`https://github-readme-streak-stats.herokuapp.com/?user=${u}&theme=transparent&${q}&ring=00d4ff&fire=00d4ff&currStreakLabel=00d4ff&sideLabels=6b8599&dates=6b8599&stroke=1a3040`}
                alt="GitHub Streak" className="max-w-full rounded-xl" style={{filter:"drop-shadow(0 0 12px rgba(0,212,255,0.2))"}} />
            </div>
            <div className="flex justify-center w-full">
              <img src={`https://github-readme-activity-graph.vercel.app/graph?username=${u}&bg_color=070f1a&color=00d4ff&line=00d4ff&point=ffffff&area=true&area_color=00d4ff&hide_border=true&radius=6`}
                alt="GitHub Activity" className="max-w-full w-full rounded-xl" style={{filter:"drop-shadow(0 0 16px rgba(0,212,255,0.15))"}} />
            </div>
            <div className="flex flex-wrap justify-center gap-4">
              <img src={`https://github-readme-stats.vercel.app/api?username=${u}&show_icons=true&theme=transparent&${q}&title_color=00d4ff&icon_color=00d4ff&text_color=e2eaf2`}
                alt="GitHub Stats" className="rounded-xl max-w-full" style={{filter:"drop-shadow(0 0 10px rgba(0,212,255,0.15))"}} />
              <img src={`https://github-readme-stats.vercel.app/api/top-langs/?username=${u}&layout=compact&theme=transparent&${q}&title_color=00d4ff&text_color=e2eaf2`}
                alt="Top Languages" className="rounded-xl max-w-full" style={{filter:"drop-shadow(0 0 10px rgba(0,212,255,0.15))"}} />
            </div>
          </div>
          <div className="mt-8 text-center">
            <a href={`https://github.com/${u}`} target="_blank" rel="noreferrer"
              className="font-spacemono text-[#6b8599] text-xs tracking-widest no-underline hover:text-[#00d4ff] transition-colors duration-200">
...
function FeedbackModal({ onClose }) {
  ...
  const handleSubmit = () => {
    ...
    */
    console.log("Feedback submitted:", { type, name, email, message });
    setSent(true);
  };

  return (
    <div className="fixed inset-0 z-[200] flex items-end md:items-center justify-center bg-black/75 backdrop-blur-sm" onClick={onClose}>
      <div className="w-full max-w-[520px] bg-[#0a1929] border border-[#1a3040] rounded-t-2xl md:rounded-2xl p-8 anim-slideUp shadow-[0_-24px_60px_rgba(0,0,0,0.6)]" onClick={e=>e.stopPropagation()}>
        <div className="flex items-start justify-between mb-5">
          <div>
            <h3 className="font-orbitron text-[#e2eaf2] text-lg font-bold">Report / Feedback</h3>
            <p className="font-dmsans text-[#6b8599] text-xs mt-1">Found a bug? Have a suggestion? Let me know!</p>
          </div>
          <button onClick={onClose} className="text-[#6b8599] hover:text-[#e2eaf2] text-xl bg-transparent border-none cursor-pointer transition-colors ml-4">✕</button>
        </div>
        <div className="h-[1px] bg-gradient-to-r from-[#00d4ff] via-[#1a3040] to-transparent mb-6" />
        {sent ? (
          <div className="text-center py-8">
            <div className="text-5xl mb-4">🎉</div>
            <h4 className="font-orbitron text-[#00d4ff] text-lg mb-2">Thanks for your feedback!</h4>
            <p className="font-dmsans text-[#6b8599] text-sm">I'll look into it and get back soon.</p>
            <button onClick={onClose} className="font-spacemono text-xs text-[#00d4ff] border border-[#00d4ff] px-6 py-2.5 rounded mt-6 bg-transparent cursor-pointer hover:bg-[rgba(0,212,255,0.1)] transition-all duration-200">
              Close ✓
            </button>
          </div>
        ) : (
          <div className="flex flex-col gap-5">
            {/* Type selector */}
            <div>
              <label className="font-spacemono text-[#6b8599] text-[11px] tracking-[3px] block mb-2">TYPE</label>
              <div className="flex flex-wrap gap-2">
                {typeOptions.map(({emoji,label}) => (
                  <button key={label} onClick={() => setType(label)}
                    className={`font-spacemono text-xs px-4 py-2 rounded border cursor-pointer transition-all duration-200
                                ${type===label ? "bg-[rgba(0,212,255,0.15)] border-[#00d4ff] text-[#00d4ff]" : "bg-transparent border-[#1a3040] text-[#6b8599] hover:border-[#00d4ff] hover:text-[#e2eaf2]"}`}>
                    {emoji} {label}
                  </button>
                ))}
              </div>
            ...
            <div>
              <label className="font-spacemono text-[#6b8599] text-[11px] tracking-[3px] block mb-2">NAME <span className="text-[#2a4050] lowercase">(optional)</span></label>
              <input className="form-input" placeholder="Your name" value={name} onChange={e=>setName(e.target.value)} />
            </div>
            <div>
              <label className="font-spacemono text-[#6b8599] text-[11px] tracking-[3px] block mb-2">EMAIL <span className="text-[#2a4050] lowercase">(optional — for reply)</span></label>
              <input className="form-input" type="email" placeholder="your@email.com" value={email} onChange={e=>setEmail(e.target.value)} />
            </div>
            <div>
              <label className="font-spacemono text-[#6b8599] text-[11px] tracking-[3px] block mb-2">MESSAGE <span className="text-[#ff6b6b]">*</span></label>
              <textarea className="form-input resize-none" rows={4} placeholder="Describe the bug or share your thoughts..." value={message} onChange={e=>setMessage(e.target.value)} />
            </div>
            <button onClick={handleSubmit} disabled={!message.trim()}
              className={`font-spacemono text-xs font-bold tracking-widest py-3 rounded border-none transition-all duration-200 cursor-pointer
                          ${message.trim() ? "bg-[#00d4ff] text-black hover:-translate-y-0.5 hover:shadow-[0_0_22px_rgba(0,212,255,0.45)]" : "bg-[#1a3040] text-[#3a5060] cursor-not-allowed"}`}>
              Send Feedback ✈
            </button>
          </div>
        )}
