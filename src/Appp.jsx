...
function GitHubMap() {
  ...
  return (
    <section ref={ref} className="reveal py-24 px-[5vw] max-w-[1100px] mx-auto relative z-10">
      ...
      <div className="max-w-[760px] mx-auto relative rounded-2xl overflow-hidden border border-[#1a3040] hover:border-[#00d4ff] transition-colors duration-500">
        ...
        <div className="bg-[#070f1a] p-6 md:p-8">
          {/* Live indicator */}
          <div className="flex items-center gap-3 mb-6">
            <div className="w-2.5 h-2.5 rounded-full bg-[#00d4ff] shadow-[0_0_8px_#00d4ff] anim-blink" />
            <span className="font-spacemono text-[#00d4ff] text-[11px] tracking-[3px]">LIVE — github.com/{u}</span>
          </div>

          <div className="flex flex-col gap-5">
            {/* Streak — capped width so it doesn't stretch too wide */}
            <div className="flex justify-center">
              <img
                ...
                alt="GitHub Streak"
                className="w-full max-w-[480px] rounded-xl h-auto"
                style={{filter:"drop-shadow(0 0 10px rgba(0,212,255,0.18))"}}
              />
            </div>

            {/* Activity graph — full width of card */}
            ...
            {/* Stats + Languages side by side, each capped */}
            <div className="flex flex-wrap justify-center gap-3">
              <img
                ...
                style={{filter:"drop-shadow(0 0 8px rgba(0,212,255,0.12))", maxWidth:"340px", width:"100%"}}
              />
              <img
                ...
                alt="Top Languages"
                className="rounded-xl h-auto"
                style={{filter:"drop-shadow(0 0 8px rgba(0,212,255,0.12))", maxWidth:"280px", width:"100%"}}
              />
            </div>
          </div>
...
function FeedbackModal({ onClose }) {
  ...
  return (
    <div className="fixed inset-0 z-[200] flex items-end md:items-center justify-center bg-black/75 backdrop-blur-sm" onClick={onClose}>
      {/* max-w-[400px] + mx-4 keeps it a neat compact card on any laptop */}
      <div className="w-full max-w-[400px] mx-4 bg-[#0a1929] border border-[#1a3040] rounded-t-2xl md:rounded-2xl p-6 anim-slideUp shadow-[0_-24px_60px_rgba(0,0,0,0.6)]" onClick={e=>e.stopPropagation()}>
